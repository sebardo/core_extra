<?php
namespace CoreExtraBundle\Command\Generator;
 ...
 */
class CrudAdminLTECommand extends GenerateDoctrineCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setHelp(<<<EOT
The <info>%command.name%</info> command generates a CRUD based on a Doctrine entity with AdminLTE templte and core compatibilities.
...
EOT
    ...
    protected function getSkeletonDirs(BundleInterface $bundle = null)
    {
        ...
        $skeletonDirs[] = __DIR__.'/../../Resources/views/Generator/skeleton';
        $skeletonDirs[] = __DIR__.'/../../Resources/views/Generator';
